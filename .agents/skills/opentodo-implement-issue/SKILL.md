...
1. Resolve scope and supporting skills.
   ...
   - Before designing or changing application logic, read [opentodo-effect-ts](../opentodo-effect-ts/SKILL.md) and the relevant guides. Identify which changes are effectful application logic and which are pure functions or framework UI code; apply the corresponding rules in `AGENTS.md`, including for new modules.
