...
1. Read the scope.
   - Use the conversation, relevant repository instructions, and current implementation. For milestone work, fetch the accepted description maintained by [opentodo-create-milestone](../opentodo-create-milestone/SKILL.md) with `gh api repos/OWNER/REPO/milestones/NUMBER`. Read supplied issue references and comments before rewriting their work.
